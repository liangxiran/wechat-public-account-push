...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx28af4ea279658edb',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'b8639ce299d6228a49faa4e887f24bc4',
  ...
  USERS: [
    {
      ...
      id: '送给可爱的夏夏老婆',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'cfKBtY9kqfeHcbSNrOsAy4m5XMDhqoYdcx05ZqZiOfs',
      // 所在省份
      province: '江苏',
      // 所在城市
      city: '南京',
      ...
      openUrl: 'https://www.ted.com/talks',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '老婆', year: '2002', date: '11-23',
        },
        {
          type: '节日', name: '在一起时间', year: '2021', date: '02-22',
        },
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-02-22' },
      // 课程表相关配置
